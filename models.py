...
class Market(BaseModel):
    sport:str="MLB";market_type:str="Strikeouts";ticker:str;event_ticker:str|None=None;title:str;player:str;threshold:str;yes_bid_cents:int|None=None;yes_ask_cents:int|None=None;no_bid_cents:int|None=None;no_ask_cents:int|None=None;volume:float|None=None;liquidity_dollars:float|None=None;close_time:datetime|None=None;tradable:bool=False;tradability_reasons:list[str]=[]
class PaperCardRequest(BaseModel):
    bankroll:float=Field(default=100,ge=0);already_committed_today:float=Field(default=0,ge=0);max_bet:float=Field(default=1,ge=0);date:str|None=None;minimum_edge_points:float=Field(default=5,ge=0,le=50);use_automatic_data:bool=True;pitchers:list[PitcherModelInput]=[]
