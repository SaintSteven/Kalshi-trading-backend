...
async def build_card(request: PaperCardRequest):
    try:
        ...
        return PaperCardResponse(
            ...
            message=(
                "v2.5.1 calibration active: raw-side selection and raw-edge gate prevent calibration-created bets; rare-tail probabilities are never increased; 4+ YES and 15+ raw adjusted-edge cohorts are research-only; started games are filtered, "
